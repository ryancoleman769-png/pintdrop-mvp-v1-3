-- PintDrop: rollback partial preset Bar Tab routing
-- Restores the one-shot tab-20 / tab-30 behaviour from
-- fixed-bar-tab-oneshot-redemption-migration.sql.
-- Does NOT change voucher rows. Pint one-shot path stays.
